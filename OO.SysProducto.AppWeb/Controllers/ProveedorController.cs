...
using OfficeOpenXml;
using OO.SysProductos.BL;
using OO.SysProductos.EN;
using Rotativa.AspNetCore;

namespace OO.SysProducto.AppWeb.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        // GET: ProveedorContoller/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: ProveedorContoller/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ProveedorContoller/Create
        [HttpPost]
        ...
        // POST: ProveedorContoller/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ProveedorContoller/Delete/5
        ...
        // POST: ProveedorContoller/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
